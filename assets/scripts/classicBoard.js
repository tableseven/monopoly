...
function corrections() {
  ...
  document.getElementById('enlarge15token').innerHTML +=
    '<img src="assets/img/train_icon.png" height="60" width="65" alt="" style="position: relative; top: -20px;" />'
  ...
  document.getElementById('enlarge12token').innerHTML +=
    '<img src="assets/img/electric_icon.png" height="60" width="48" alt="" style="position: relative; top: -20px;" />'
  document.getElementById('enlarge28token').innerHTML +=
    '<img src="assets/img/water_icon.png" height="60" width="78" alt="" style="position: relative; top: -20px;" />'
}
