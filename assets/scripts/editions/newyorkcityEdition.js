...
function citytax() {
  ...
  if (p.human) {
    ...
    buttonBonclick =
      ' hide("popupbackground"); hide("popupwrap"); var p=player[turn]; var cost=p.money; for(var i=0; i<40; i++){sq=square[i]; if(sq.owner==turn) { if(sq.mortgage) { cost+=sq.price*0.5; } else { cost+=sq.price; } cost+=(sq.house*sq.houseprice); } } cost*=0.1; cost=Math.round(cost); addalert(p.name+" paid $"+cost+" for landing on City Tax."); p.pay(cost,0);'

    popup(
      "You landed on City Tax. You must pay $200 or ten percent of your total worth.<div><input type='button' value='Pay $200' onclick='" +
        buttonAonclick +
        "' /><input type='button' value='Pay 10%' onclick='" +
        buttonBonclick +
        "' /></div>",
      false
    )
...
square[31] = new Square('The Regency Hotel', '$300', 'green', 300, 9, 26, 130, 390, 900, 110, 1275)
square[32] = new Square('Essex House', '$300', 'green', 300, 9, 26, 130, 390, 900, 110, 1275)
...
communityChestCards[0] = new Card('Get out of Jail, Free. This card may be kept until needed or sold.', function () {
  p.communityChestJailCard = true
  updateOwned()
})
communityChestCards[1] = new Card('You have won lifetime home delivery of the New York Times. Collect $10', function () {
  addamount(10, 'Community Chest')
})
communityChestCards[2] = new Card("From sale of Macy's stock, you get $45", function () {
...
communityChestCards[4] = new Card('Deloitte & Touche LLP tax return Collect $20', function () {
  addamount(20, 'Community Chest')
})
communityChestCards[5] = new Card('FAO Schwarz Xmas fund matures. Collect $100', function () {
  addamount(100, 'Community Chest')
})
communityChestCards[6] = new Card('You have won a United Airlines trip around the world! Collect $100', function () {
  addamount(100, 'Community Chest')
})
communityChestCards[7] = new Card('Performed a wedding at the Plaza Hotel. Receive $25', function () {
  addamount(25, 'Community Chest')
})
communityChestCards[8] = new Card('Pay hospital $100', function () {
  subtractamount(100, 'Community Chest')
})
communityChestCards[9] = new Card('You won the Lottery! Collect $200', function () {
  addamount(200, 'Community Chest')
})
communityChestCards[10] = new Card('Pay school tax of $150', function () {
...
communityChestCards[12] = new Card('Madison Square Garden opening tonight. Collect $50 from every player for opening night seats.', function () {
  collectfromeachplayer(50, 'Community Chest')
})
communityChestCards[13] = new Card('You have won kiss cash! Advance to GO (Collect $200)', function () {
  advance(0)
})
...
chanceCards[0] = new Card('Get out of Jail free. This card may be kept until needed or sold.', function () {
...
chanceCards[2] = new Card('Pay poor tax of $15.', function () {
  subtractamount(15, 'Chance')
})
chanceCards[3] = new Card('You have been elected chairman of Con Edison. Pay each player $50.', function () {
  payeachplayer(50, 'Chance')
})
chanceCards[4] = new Card('Go back 3 spaces.', function () {
  gobackthreespaces()
})
...
chanceCards[6] = new Card('Citibank pays you interest of $50.', function () {
  addamount(50, 'Chance')
})
...
chanceCards[8] = new Card('Take a walk past The Essex House. Advance to GO. Collect $200.', function () {
  advance(0, 32)
})
chanceCards[9] = new Card('Take a ride to the Regency Hotel! If you pass GO collect $200.', function () {
  advance(31)
})
chanceCards[10] = new Card('Take a walk on fifth avenue. Advance token to Trump Tower.', function () {
  advance(39)
})
chanceCards[11] = new Card('Advance to thirteen.', function () {
  advance(13)
})
chanceCards[12] = new Card('Your Smith Barney mutual fund pays dividend. Collect $150.', function () {
  addamount(150, 'Chance')
})
chanceCards[13] = new Card(
  'Advance token to the nearest Transportation and pay owner Twice the Rental to which they are otherwise entitled.\n\nIf Transportation is unowned, you may buy it from the Bank.',
  function () {
    advanceToNearestRailroad()
  }
)
chanceCards[14] = new Card('Catch a bus to Central Park. If you pass GO, collect $200.', function () {
  advance(9)
})
chanceCards[15] = new Card('Go directly to Jail. Do not pass GO, do not collect $200.', function () {
  gotojail()
})
